            ...
            <nav className="nav bd-grid">
                ...
                <div className="nav__menu" id="nav-menu">
                    <ul className="nav__list">
                        ...
                        <li className="nav__item"><a href="#men" className="nav__link">Men</a></li>
                ...
                <div className="nav__box-feature">
                    <div className="nav__search-box">
                        <input className="nav__search-box--input-search is-none" type="text" placeholder="Search" />
                        <button className="btn-search"><i className='bx bx-search'></i></button>
                        <button className="btn-search btn-overlay-search is-none"><i className='bx bx-search'></i></button>
                        <button className="nav__close-search-box is-none-btn"><i className='bx bx-x'></i></button>
                    </div>
        ...
        <div className="main-header">
            <div className="main-header__container">
                <div className="main-header__content bd-grid">
                    <h1 className="main-header__title">Men's Shoes <span className="main-header__count">(385)</span></h1>
                    <nav className="main-header__navbar">
                        <button className="main-header__filter-btn">
                            <span className="main-header__filter-btn--text">Show Filters</span>
                            <i className='bx bxs-chevron-left'></i>
                        </button>
                        <button className="main-header__short">
                            <span className="main-header__short--text">Short By</span>
